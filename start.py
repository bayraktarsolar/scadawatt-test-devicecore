            ...
            for i in cvp["data"]:
                                    ...
                                    if mac_degisecek:
                                        ...
                                        if client_file is not False:
                                            ...
                                            if last4 is not False:
                                                ...
                                                sifre = "scd_"+ last4 
                                                # i["swd_mac"] = "5c:ad:a3:a7:" + last4[0:2] + ":" + last4[2:4]
                ...
                if(kontrol_1):
                    ...
                    if ret_update[2]:
                        ...
                        time.sleep(10)
                        for a in range(120):
                            #print("ip:",ip,"kullanici:",kullanici,"sifre:",sifre) #mert
                    ...
                    while tekrar_dene < 30:
                        ...
                        cvp = json.loads(rs.text)
                        #mert
                        # with open("mert_log.txt", "a", encoding="utf-8") as dosya:
                        #     dosya.write("son istek : ")
                        #     dosya.write(str(cvp)+"\n")
                        #     dosya.write("ilk istek : ")
                        #     dosya.write(str(mertcvp)+"\n")
                        #     dosya.write("ilk mac : ")
                        #     dosya.write(i["swd_mac"])
                        #     dosya.write("is_tekrar_baglanti : ")
                        #     dosya.write(str(is_tekrar_baglanti)+"\n")
